var amber = {
  ...
  translations : {
    en : {
      ...
      '<a class="amber-focus" href="{{CACHE}}">View the capture</a><div class="amber-iframe-container"><a href="{{LINK}}"></a><iframe sandbox="" src="{{LINK}}"/></div><a class="amber-original-link" href="{{LINK}}">Continue to the page</a></div><a class="amber-info" href="http://amberlink.org" target="_blank">i</a></div>',
      ...
      '<a class="amber-focus" href="{{CACHE}}">View the capture</a><div class="amber-iframe-container"><a href="{{LINK}}"></a><iframe sandbox="" src="{{LINK}}"/></div><a class="amber-original-link" href="{{LINK}}">Continue to the page</a></div><a class="amber-info" href="http://amberlink.org" target="_blank">i</a></div>',
      hover_html_up   : '<div class="amber-hover amber-up"><a class="amber-info" href="http://amberlink.org" target="_blank">i</a><div class="amber-text"><div class="amber-status-text">This page should be available</div><div class="amber-cache-text">{{NAME}} has a capture from {{DATE}}</div></div><div class="amber-links"><a href="{{CACHE}}">View the capture</a><a href="{{LINK}}" class="amber-focus">Continue to the page</a></div><div class="amber-arrow"></div></div>',
      hover_html_down : '<div class="amber-hover amber-down"><a class="amber-info" href="http://amberlink.org" target="_blank">i</a><div class="amber-text"><div class="amber-status-text">This page may not be available</div><div class="amber-cache-text">{{NAME}} has a capture from {{DATE}}</div></div><div class="amber-links"><a href="{{CACHE}}" class="amber-focus">View the capture</a><a href="{{LINK}}">Continue to the page</a></div><div class="amber-arrow"></div></div>',
      this_site: "This site"
    },
    fa : {
      interstitial_html_up :
